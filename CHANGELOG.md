...
- **Перевод между своими счетами больше не считается тратой.** Правило жило в
  питоновском скрипте сборки дашборда и больше нигде: веб показывал расходы
  275 015,96, движок — 277 015,96. Разница ровно одна запись 2000 ₽, и понять
  по числам, какая сторона права, было нельзя. Теперь это вопрос домена —
...
- **Суммы печатаются с разделёнными разрядами** (`275 015,96`): найти ошибку на
