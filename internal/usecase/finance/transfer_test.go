...
// Сводка не должна считать перекладывание денег тратой. На живой книге это одна
// запись 2000 ₽ от 04.05 («возврат переплаты заказчику»), и из-за неё веб и
// терминал показывали разные расходы: 275 015,96 против 277 015,96.
