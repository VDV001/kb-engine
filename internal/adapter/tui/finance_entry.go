...
const (
	...
	// У формы баланса своя подсказка: стрелки листают счета книги, и клавиша,
	// о которой не сказано, для человека не существует.
	hintBalanceForm = "←→ — счёт · буквы — новое имя · Tab — поле · Enter — записать · Esc — отмена"
)
